...
img=io.imread('num-0.png',as_gray=True)
io.imshow(img)
...
x_train,x_test,y_train,y_test = train_test_split(x,y,test_size=0.9)# 20%作为测试集
...
print(y_predict[1:100])#预测结果
print(y_test[1:100])#真实结果
